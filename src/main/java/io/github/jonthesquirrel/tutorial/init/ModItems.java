...
import io.github.jonthesquirrel.tutorial.util.enums.ModArmorMaterial;
import io.github.jonthesquirrel.tutorial.util.enums.ModItemTier;
...
public class ModItems {
    ...
    public static final RegistryObject<PoisonApple> POISON_APPLE = ITEMS.register(
            "poison_apple",
            PoisonApple::new
    );
